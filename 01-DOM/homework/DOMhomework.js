...
span.innerHTML += " Geronimo";// selecciona al tag span y dentro igresa el nobmre
...
function buildToDo(todo, index) {
  ...
  toDoShell.className = "toDoShell" // crea un div y agrega una clase todoshell

  let toDoText = document.createElement("span")
  toDoText.innerHTML = todo.description // el inner html que se genera como argumento, corresponde a la descripcion
  toDoText.id = index; // crea el atributo y le asigna ese valor 
...
function displayToDos() {
  ...
  // result = array y dentro va a contener una cantidad de tareas correspondiente al array de todos
