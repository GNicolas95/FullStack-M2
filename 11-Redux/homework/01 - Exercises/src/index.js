...
botonIncremento.addEventListener("click", () => {store.dispatch(incremento(1))})

botonDecremento.addEventListener("click", () => {store.dispatch(decremento())})

impar.addEventListener("click", () => {store.getState().contador % 2 !== 0 && store.dispatch(incremento(1))})

incrementoAsync.addEventListener("click", () => {setTimeout(() => {store.dispatch(incremento(1))}, 2000)})
